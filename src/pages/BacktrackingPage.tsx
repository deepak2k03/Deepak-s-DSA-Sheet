...
const problems: Problem[] = [
  {
    ...
    solutionLink: 'https://github.com/solutions/n-queens',
    codeLink: 'https://github.com/code/n-queens'
  },
  {
    id: 2,
    title: "Largest Number In K Swaps",
    link: 'https://www.geeksforgeeks.org/problems/largest-number-in-k-swaps-1587115620/1',
    solutionLink: 'https://github.com/solutions/sudoku-solver',
    codeLink: 'https://github.com/code/sudoku-solver'
  },
  {
    id: 3,
    title: "Combination Sum",
    link: 'https://leetcode.com/problems/combination-sum/',
    solutionLink: 'https://github.com/solutions/permutations',
    codeLink: 'https://github.com/code/permutations'
  },
  {
    id: 4,
    title: "Combination Sum II",
    link: 'https://leetcode.com/problems/combination-sum-ii/description/',
    solutionLink: 'https://github.com/solutions/combination-sum',
    codeLink: 'https://github.com/code/combination-sum'
  },
  {
    id: 5,
    title: "Combination Sum III",
    link: 'https://leetcode.com/problems/combination-sum-iii/description/',
    solutionLink: 'https://github.com/solutions/word-search',
    codeLink: 'https://github.com/code/word-search'
  },
  {
    id: 6,
        ...
        <div className="mb-8">
          ...
          <div className="text-center mb-8">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-4">
              ...
              <a
                href="https://github.com/notes/backtracking"
                target="_blank"
