...
const problems: Problem[] = [
  ...
  },
  {
    ...
    solutionLink: 'https://github.com/solutions/container-most-water',
    codeLink: 'https://github.com/code/container-most-water'
  },
  {
    id: 3,
    title: "Fruit Into Baskets",
    link: 'https://www.geeksforgeeks.org/problems/fruit-into-baskets-1663137462/1',
    solutionLink: 'https://github.com/solutions/sliding-window-maximum',
    codeLink: 'https://github.com/code/sliding-window-maximum'
  },
  {
    id: 4,
    title: "longest repeating character replacement",
    link: 'https://leetcode.com/problems/longest-repeating-character-replacement/',
    solutionLink: 'https://github.com/solutions/minimum-window-substring',
    codeLink: 'https://github.com/code/minimum-window-substring'
  },
  {
    id: 5,
  ...
  },
  {
    ...
    link: 'https://www.naukri.com/code360/problems/minimum-window-subsequence_2181133',
    solutionLink: 'https://github.com/solutions/minimum-window-substring',
    codeLink: 'https://github.com/code/minimum-window-substring'
  }
];

const SlidingWindowsTwoPointersPage: React.FC = () => {
  return (
        ...
        <div className="mb-8">
          ...
          <div className="text-center mb-8">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-4">
              ...
              <a
                href="https://github.com/notes/sliding-windows-two-pointers"
                target="_blank"
...
export default SlidingWindowsTwoPointersPage;