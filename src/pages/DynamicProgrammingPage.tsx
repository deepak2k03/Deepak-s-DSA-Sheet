...
const problems: Problem[] = [
  {
    ...
    solutionLink: 'https://github.com/solutions/climbing-stairs',
    codeLink: 'https://github.com/code/climbing-stairs'
  },
  {
    id: 2,
    title: "House Robber",
    link: 'https://leetcode.com/problems/house-robber/',
    solutionLink: 'https://github.com/solutions/house-robber',
    codeLink: 'https://github.com/code/house-robber'
  },
  {
    id: 3,
    title: "Coin Change",
    link: 'https://leetcode.com/problems/coin-change/',
    solutionLink: 'https://github.com/solutions/coin-change',
    codeLink: 'https://github.com/code/coin-change'
  },
  {
    id: 4,
    title: "Longest Increasing Subsequence",
    link: 'https://leetcode.com/problems/longest-increasing-subsequence/',
    solutionLink: 'https://github.com/solutions/longest-increasing-subsequence',
    codeLink: 'https://github.com/code/longest-increasing-subsequence'
  },
  {
    id: 5,
    title: "0/1 Knapsack Problem",
    link: 'https://leetcode.com/problems/knapsack/',
    solutionLink: 'https://github.com/solutions/knapsack',
    codeLink: 'https://github.com/code/knapsack'
  }
];
        ...
        <div className="mb-8">
          ...
          <div className="text-center mb-8">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-4">
              ...
              <a
                href="https://github.com/notes/dynamic-programming"
                target="_blank"
