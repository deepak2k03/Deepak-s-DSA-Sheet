...
const problems: Problem[] = [
  {
    id: 1,
    title: "Largets Element in an Array",
    link: 'https://www.geeksforgeeks.org/problems/largest-element-in-array4009/1',
    solutionLink: 'https://github.com/solutions/two-sum',
    codeLink: 'https://github.com/code/two-sum'
  },
  {
    id: 2,
    title: "Second Largets Element in an Array",
    link: 'https://www.geeksforgeeks.org/problems/second-largest3735/1',
    solutionLink: 'https://github.com/solutions/stock-prices',
    codeLink: 'https://github.com/code/stock-prices'
  },
  {
    id: 3,
    title: "Check if Array is Sorted",
    link: 'https://www.geeksforgeeks.org/problems/check-if-an-array-is-sorted0701/1',
    solutionLink: 'https://github.com/solutions/contains-duplicate',
    codeLink: 'https://github.com/code/contains-duplicate'
  },
  {
    id: 4,
    title: "Remove Duplicated From Sorted Array",
    link: 'https://leetcode.com/problems/remove-duplicates-from-sorted-array/description/',
    solutionLink: 'https://github.com/solutions/product-array',
    codeLink: 'https://github.com/code/product-array'
  },
  {
    id: 5,
    title: "Left Rotate Array By one Place",
    link: 'https://www.naukri.com/code360/problems/left-rotate-an-array-by-one_5026278',
    solutionLink: 'https://github.com/solutions/max-subarray',
    codeLink: 'https://github.com/code/max-subarray'
  },
  {
    id: 6,
  ...
  {
    id: 7,
    title: "Right Rotate Array By one Place",
  ...
  {
    id: 8,
    title: "Right Rotate Array By d Place",
  ...
  {
    id: 11,
    title: "Find the Missing Number in the array",
  ...
  },
  {
    ...
    link: 'https://www.geeksforgeeks.org/dsa/print-the-maximum-subarray-sum/',
    solutionLink: 'https://github.com/solutions/max-subarray',
    codeLink: 'https://github.com/code/max-subarray'
  },
  {
        ...
        <div className="mb-8">
          ...
          <div className="text-center mb-8">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-4">
              ...
              <a
                href="https://github.com/notes/arrays"
                target="_blank"
            ...
            <p className="text-gray-700 dark:text-blue-200 text-lg max-w-2xl mx-auto">
              Master array manipulation, indexing, and traversal techniques
            </p>
