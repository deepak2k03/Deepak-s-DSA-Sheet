...
const problems: Problem[] = [
  {
    ...
    solutionLink: 'https://github.com/solutions/binary-tree-inorder',
    codeLink: 'https://github.com/code/binary-tree-inorder'
  },
  {
    id: 2,
    title: "Maximum Depth of Binary Tree",
    link: 'https://leetcode.com/problems/maximum-depth-of-binary-tree/',
    solutionLink: 'https://github.com/solutions/max-depth-binary-tree',
    codeLink: 'https://github.com/code/max-depth-binary-tree'
  },
  {
    id: 3,
    title: "Same Tree",
    link: 'https://leetcode.com/problems/same-tree/',
    solutionLink: 'https://github.com/solutions/same-tree',
    codeLink: 'https://github.com/code/same-tree'
  },
  {
    id: 4,
    title: "Validate Binary Search Tree",
    link: 'https://leetcode.com/problems/validate-binary-search-tree/',
    solutionLink: 'https://github.com/solutions/validate-bst',
    codeLink: 'https://github.com/code/validate-bst'
  },
  {
    id: 5,
    title: "Lowest Common Ancestor of a Binary Tree",
    link: 'https://leetcode.com/problems/lowest-common-ancestor-of-a-binary-tree/',
    solutionLink: 'https://github.com/solutions/lowest-common-ancestor',
    codeLink: 'https://github.com/code/lowest-common-ancestor'
  }
];
        ...
        <div className="mb-8">
          ...
          <div className="text-center mb-8">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-4">
              ...
              <a
                href="https://github.com/notes/trees"
                target="_blank"
            ...
            <p className="text-gray-700 dark:text-blue-200 text-lg max-w-2xl mx-auto">
              Binary trees, BSTs, and tree traversal algorithms
            </p>
