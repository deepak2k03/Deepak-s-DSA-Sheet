...
const problems: Problem[] = [
  {
    ...
    solutionLink: 'https://github.com/solutions/binary-search',
    codeLink: 'https://github.com/code/binary-search'
  },
  {
    id: 2,
    title: "Implement Lower Bound",
    link: 'https://www.geeksforgeeks.org/problems/implement-lower-bound/1',
    solutionLink: 'https://github.com/solutions/search-insert',
    codeLink: 'https://github.com/code/search-insert'
  },
  {
    id: 3,
    title: "Implement Upper Bound",
    link: 'https://www.geeksforgeeks.org/problems/implement-upper-bound/1',
    solutionLink: 'https://github.com/solutions/first-last-position',
    codeLink: 'https://github.com/code/first-last-position'
  },
  {
    id: 4,
    title: "Search Insert Position",
    link: 'https://leetcode.com/problems/search-insert-position/description/',
    solutionLink: 'https://github.com/solutions/search-rotated',
    codeLink: 'https://github.com/code/search-rotated'
  },
  {
    id: 5,
    title: "Floor in Sorted Array",
    link: 'https://www.geeksforgeeks.org/problems/floor-in-a-sorted-array-1587115620/1',
    solutionLink: 'https://github.com/solutions/peak-element',
    codeLink: 'https://github.com/code/peak-element'
  },
  {
    id: 6,
  ...
  },
  {
    ...
    link: 'https://www.geeksforgeeks.org/dsa/find-rotation-count-rotated-sorted-array/',
    solutionLink: 'https://github.com/solutions/peak-element',
    codeLink: 'https://github.com/code/peak-element'
  },
  {
  ...
  {
    id: 16,
    title: "Find square root of a number in logn",
        ...
        <div className="mb-8">
          ...
          <div className="text-center mb-8">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-4">
              ...
              <a
                href="https://github.com/notes/binary-search"
                target="_blank"
            ...
            <p className="text-gray-700 dark:text-blue-200 text-lg max-w-2xl mx-auto">
              Divide and conquer search algorithm for sorted arrays
            </p>
