...
const problems: Problem[] = [
  {
    ...
    solutionLink: 'https://github.com/solutions/range-sum-query-mutable',
    codeLink: 'https://github.com/code/range-sum-query-mutable'
  },
  {
    id: 2,
    title: "Range Minimum Query",
    link: 'https://leetcode.com/problems/range-minimum-query/',
    solutionLink: 'https://github.com/solutions/range-minimum-query',
    codeLink: 'https://github.com/code/range-minimum-query'
  },
  {
    id: 3,
    title: "Count of Smaller Numbers After Self",
    link: 'https://leetcode.com/problems/count-of-smaller-numbers-after-self/',
    solutionLink: 'https://github.com/solutions/count-smaller-numbers',
    codeLink: 'https://github.com/code/count-smaller-numbers'
  },
  {
    id: 4,
    title: "The Skyline Problem",
    link: 'https://leetcode.com/problems/the-skyline-problem/',
    solutionLink: 'https://github.com/solutions/skyline-problem',
    codeLink: 'https://github.com/code/skyline-problem'
  },
  {
    id: 5,
    title: "Range Sum Query 2D - Mutable",
    link: 'https://leetcode.com/problems/range-sum-query-2d-mutable/',
    solutionLink: 'https://github.com/solutions/range-sum-query-2d',
    codeLink: 'https://github.com/code/range-sum-query-2d'
  }
];

const SegmentTreesPage: React.FC = () => {
  return (
        ...
        <div className="mb-8">
          ...
          <div className="text-center mb-8">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-4">
              ...
              <a
                href="https://github.com/notes/segment-trees"
                target="_blank"
            ...
            <p className="text-gray-700 dark:text-blue-200 text-lg max-w-2xl mx-auto">
              Advanced tree structure for range queries and updates
            </p>
