...
const problems: Problem[] = [
  {
    ...
    solutionLink: 'https://github.com/solutions/bubble-sort',
    codeLink: 'https://github.com/code/bubble-sort'
  },
  {
    id: 2,
    title: "Selection Sort",
    link: 'https://www.geeksforgeeks.org/dsa/selection-sort-algorithm-2/',
    solutionLink: 'https://github.com/solutions/selection-sort',
    codeLink: 'https://github.com/code/selection-sort'
  },
  {
    id: 3,
    title: "Insertion Sort",
    link: 'https://www.geeksforgeeks.org/problems/insertion-sort/1',
    solutionLink: 'https://github.com/solutions/insertion-sort',
    codeLink: 'https://github.com/code/insertion-sort'
  },
  {
    id: 4,
    title: "Merge Sort",
    link: 'https://www.geeksforgeeks.org/problems/merge-sort/1',
    solutionLink: 'https://github.com/solutions/merge-sort',
    codeLink: 'https://github.com/code/merge-sort'
  },
  {
    id: 5,
    title: "Recursive Bubble Sort",
    link: 'https://www.geeksforgeeks.org/problems/bubble-sort/1',
    solutionLink: 'https://github.com/solutions/quick-sort',
    codeLink: 'https://github.com/code/quick-sort'
  },
  {
    id: 6,
        ...
        <div className="mb-8">
          ...
          <div className="text-center mb-8">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-4">
              ...
              <a
                href="https://github.com/notes/sorting"
                target="_blank"
            ...
            <p className="text-gray-700 dark:text-blue-200 text-lg max-w-2xl mx-auto">
              Efficient algorithms for ordering and arranging elements
            </p>
