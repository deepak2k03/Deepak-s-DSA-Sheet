...
const problems: Problem[] = [
  ...
  },
  {
    ...
    solutionLink: 'https://github.com/solutions/add-search-words',
    codeLink: 'https://github.com/code/add-search-words'
  },
  {
    id: 4,
    title: "Word Break",
    link: 'https://leetcode.com/problems/word-break/',
    solutionLink: 'https://github.com/solutions/word-break',
    codeLink: 'https://github.com/code/word-break'
  },
  {
    id: 5,
    title: "Palindrome Pairs",
    link: 'https://leetcode.com/problems/palindrome-pairs/',
    solutionLink: 'https://github.com/solutions/palindrome-pairs',
    codeLink: 'https://github.com/code/palindrome-pairs'
  }
];
        ...
        <div className="mb-8">
          ...
          <div className="text-center mb-8">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-4">
              ...
              <a
                href="https://github.com/notes/tries"
                target="_blank"
